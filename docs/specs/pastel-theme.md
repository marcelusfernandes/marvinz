...
[data-flavor='pastel'] {
  ...
  --shell-wash: rgba(235, 224, 210, 0.85);  /* surface-2 base, 0.85 opacity resists vibrancy lightening */

  /* === Shadows — warm clay tint === */
  --shadow-sm: 0 1px 2px rgba(60, 35, 10, 0.06);
  --shadow-md: 0 4px 12px rgba(60, 35, 10, 0.10);
  --shadow-lg: 0 12px 30px rgba(60, 35, 10, 0.18);

  /* === Focus ring — warm tint === */
  --focus-ring:       0 0 0 3px rgba(92, 60, 30, 0.35);
  --focus-ring-inset: inset 0 0 0 2px rgba(92, 60, 30, 0.50);
}
```
...
[data-flavor='pastel'][data-theme='dark'] {
  ...
  --focus-ring-inset: inset 0 0 0 2px rgba(255, 200, 150, 0.50);
}
```
